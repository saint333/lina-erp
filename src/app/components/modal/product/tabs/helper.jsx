...
export const handleCategory = async (e, setFormValue, setValueSelect, valueSelect) => {
  setFormValue("type", "");
...
export const handleType = async (e, setFormValue, setValueSelect, valueSelect) => {
  setFormValue("brand", "");
...
const handleBrand = async (e, setFormValue, setValueSelect, valueSelect, brand) => {
  setFormValue("model", "");
...
export const handleModel = async (e, setFormValue, setValueSelect, valueSelect) => {
...
const handleFinish = async (e, setFormValue, setValueSelect, valueSelect, finish) => {
