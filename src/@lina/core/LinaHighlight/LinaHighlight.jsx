 ...
 */
const LinaHighlight = forwardRef((props, ref) => {
...
function trimCode(children) {
	...
	// can be formatted properly while using lina-highlight
	// component
...
export default memo(styled(LinaHighlight)``);
