import { useDeepCompareEffect } from '@lina/hooks';
...
import LinaLoading from '../LinaLoading';
 ...
 */
function LinaLayout(props) {
	const { layouts, children } = props;
	const dispatch = useAppDispatch();
	const settings = useAppSelector(selectLinaCurrentSettings);
	const defaultSettings = useAppSelector(selectLinaDefaultSettings);
