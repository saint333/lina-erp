...
export const changeLinaTheme = createAsyncThunk(
	'linaSettings/changeLinaTheme',
	async (theme, { dispatch, getState }) => {
		const AppState = getState();
		const settings = AppState.linaSettings;
...
export const setDefaultSettings = createAsyncThunk(
	'linaSettings/setDefaultSettings',
 ...
 * The settings slice.
 */
export const linaSettingsSlice = createSlice({
	name: 'linaSettings',
	initialState,
	reducers: {
	...
	selectors: {
		selectLinaSettings: (linaSettings) => linaSettings,
		selectLinaSettingsDefaults: (linaSettings) => linaSettings.defaults,
		selectLinaSettingsCurrent: (linaSettings) => linaSettings.current,
		selectLinaCurrentSettings: (linaSettings) => linaSettings.current,
		getDirection: (linaSettings) => linaSettings.current.direction,
		getMainTheme: (linaSettings) => linaSettings.current.theme.main,
		getNavbarTheme: (linaSettings) => linaSettings.current.theme.navbar,
		getToolbarTheme: (linaSettings) => linaSettings.current.theme.toolbar,
		getFooterTheme: (linaSettings) => linaSettings.current.theme.footer,
		selectLinaCurrentLayoutConfig: (linaSettings) => linaSettings.current.layout.config,
		selectLinaDefaultSettings: (linaSettings) => linaSettings.defaults,
		selectCustomScrollbarsEnabled: (linaSettings) => linaSettings.current.customScrollbars
	}
});
export const {
	selectLinaCurrentLayoutConfig,
	selectLinaCurrentSettings,
	selectLinaSettings,
	selectLinaSettingsDefaults,
	selectLinaSettingsCurrent,
	selectLinaDefaultSettings,
...
// export const selectLinaThemesSettings = (state: RootState) => state.linaSettings.themes;
export const { resetSettings, setInitialSettings, setSettings } = linaSettingsSlice.actions;
export default linaSettingsSlice.reducer;
