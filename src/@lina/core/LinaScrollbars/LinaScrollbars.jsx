...
import { selectCustomScrollbarsEnabled } from '@lina/core/LinaSettings/linaSettingsSlice';
...
/**
 * LinaScrollbars Component for app-level scrollbar
 * Unlike normal scrollbars, this component supports mobile device as well
 */
const LinaScrollbars = forwardRef((props, ref) => {
	const {
		className = '',
		children,
		id = '',
