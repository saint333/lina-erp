import { linaDark } from '@lina/colors';
...
/**
 * The defaultSettings object defines the default settings for the Lina application.
 */
...
/**
 * The getParsedQuerySettings function parses the query string to retrieve the default settings for the Lina application.
 * It returns a LinaSettingsConfigType object that can be used to configure the application.
 */
